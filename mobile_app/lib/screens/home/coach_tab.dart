...
class _CoachTabState extends State<CoachTab> {
  ...
  final List<Map<String, String>> _messages = [
    {
      'role': 'assistant',
      'text': 'Ask about your workouts, recovery, pain-safe substitutions, or next-week adjustments. This local MVP uses a backend coaching endpoint with conservative safety language.'
    }
  ];
  bool _sending = false;
