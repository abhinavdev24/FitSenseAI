...
class Condition(Base):
    ...
    condition_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    name: Mapped[str] = mapped_column(String(120), unique=True)
    description: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class UserMedicalProfile(Base):
    ...
    medical_profile_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
...
class UserMedication(Base):
    ...
    medication_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.user_id"), index=True)
...
class UserAllergy(Base):
    ...
    allergy_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.user_id"), index=True)
...
class UserPreference(Base):
    ...
    preference_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.user_id"), unique=True, index=True)
...
class Equipment(Base):
    ...
    equipment_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    name: Mapped[str] = mapped_column(String(120), unique=True)
...
class Exercise(Base):
    ...
    exercise_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
...
class WorkoutPlan(Base):
    ...
    plan_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.user_id"), index=True)
...
class PlanDay(Base):
    ...
    plan_day_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
...
class PlanExercise(Base):
    ...
    plan_exercise_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
...
class PlanSet(Base):
    ...
    plan_set_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
...
class Workout(Base):
    ...
    workout_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.user_id"), index=True)
...
class WorkoutExercise(Base):
    ...
    workout_exercise_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
...
class WorkoutSet(Base):
    ...
    workout_set_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
...
class CalorieIntakeLog(Base):
    ...
    calorie_log_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.user_id"), index=True)
...
class SleepDurationLog(Base):
    ...
    sleep_log_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.user_id"), index=True)
    logged_on: Mapped[date] = mapped_column(Date)
...
class WeightLog(Base):
    ...
    weight_log_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.user_id"), index=True)
...
class AIInteraction(Base):
    ...
    ai_interaction_id: Mapped[str] = mapped_column(String, primary_key=True, default=_uuid)
    user_id: Mapped[str] = mapped_column(ForeignKey("users.user_id"), index=True)
